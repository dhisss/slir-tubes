...
<html lang="en">
  <head>
    ...
    <title>Laporan Belum divalidasi</title>
...
<div class="card text-center">
  <div class="card-header">
    <ul class="nav nav-tabs card-header-tabs">
      <li class="nav-item">
        <a class="nav-link" id="semua-tab" data-toggle="tab" href="/dashboard" role="tab" aria-controls="semua" aria-selected="false">Semua</a>
      </li>
      <li class="nav-item">
        <a class="nav-link active" id="belumvld-tab" data-toggle="tab" href="/belumvld" role="tab" aria-controls="belumvld" aria-selected="true">Proses Validasi</a>
      </li>
      <li class="nav-item">
