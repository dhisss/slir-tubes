      ...
      <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h2">Proses Perbaikan</h1>
  ...
  <div class="card-header">
    <ul class="nav nav-tabs card-header-tabs">
      ...
      <li class="nav-item">
        ...
        <li class="nav-item">
        <a class="nav-link  active" id="prosesvld-tab" data-toggle="tab" href="prosesvld" role="tab" aria-controls="prosesvld" aria-selected="false">Proses perbaikan</a>
      </li>
      <li class="nav-item">
