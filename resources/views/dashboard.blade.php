...
<div class="card text-center">
  <div class="card-header">
    <ul class="nav nav-tabs card-header-tabs">
      <li class="nav-item">
        <a class="nav-link  active" id="semua-tab" data-toggle="tab" href="/dashboard" role="tab" aria-controls="semua" aria-selected="true">Semua</a>
      </li>
      <li class="nav-item">
    ...
    <h5 class="card-title">Semua Laporan</h5>
       ...
       <?php
        ...
        while($laporan = mysqli_fetch_array($query)){
            ...
            echo "<td>";
            echo "<a href='/laporanadmin?id=".$laporan['id']."'>Lihat</a> | ";
            echo "<a href='hapus.php?id=".$laporan['id']."'>Hapus</a>";
            echo "<td>".$laporan['validasi']."</td>";
            echo "</td>";
