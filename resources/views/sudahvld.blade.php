...
<div class="card text-center">
  <div class="card-header">
    <ul class="nav nav-tabs card-header-tabs">
      ...
      <li class="nav-item">
        <a class="nav-link active" id="sudahvld-tab" data-toggle="tab" href="/sudahvld" role="tab" aria-controls="sudahvld" aria-selected="true">Sudah di Validasi</a>
      </li>
      <li class="nav-item">
