...
<html lang="en">
  <head>
    ...
    <title>Selesai diperbaiki</title>
      ...
      <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h2">Laporan selesai diperbaiki</h1>
...
<div class="card text-center">
  <div class="card-header">
    <ul class="nav nav-tabs card-header-tabs">
      ...
      <li class="nav-item">
        <a class="nav-link" id="tidakvld-tab" data-toggle="tab" href="tidakvld" role="tab" aria-controls="tidakvld" aria-selected="false">Tidak  Valid</a>
      </li>
        <li class="nav-item">
      ...
      <li class="nav-item">
        <a class="nav-link active" id="selesaivld-tab" data-toggle="tab" href="selesaivld" role="tab" aria-controls="selesaivld" aria-selected="false">Selesai diperbaiki</a>
      </li>
    </ul>
  </div>
  <form>
    ...
    <h5 class="card-title">Semua Laporan</h5>
       ...
       <?php
        ...
        while($laporan = mysqli_fetch_array($query)){
            ...
            echo "<td>".$laporan['nama_inf']."</td>";
            echo "<td>".$laporan['tingkat_kerusakan']."</td>";
            echo "<td>".$laporan['kecamatan']."</td>";
            echo "<td>".$laporan['nama']."</td>";
            echo "<td>".$laporan['tanggal']."</td>";            
            echo "<td>";
            echo "<a href='form-edit.php?id=".$laporan['id']."'>Lihat</a> | ";
