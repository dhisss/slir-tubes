...
$daftar = "INSERT INTO registrasi2 (email,password,nama_instansi,alamat,region,kota,kecamatan,kode_pos) values ('$email','$password','$nama_instansi','$alamat','$region','$kota','$kecamatan','$kode_pos')";
$q = $koneksi->query($daftar);
if ($q == TRUE){
echo "<script>alert('Berhasil Mendaftar')</script>";
echo "<meta http-equiv='refresh' content='1 url=hompage.blade.php'>";
}else{
